...
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/AgentKnowledgeApplication.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/error/ApiErrorResponse.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/error/ErrorCode.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/error/GlobalExceptionHandler.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/error/ResourceNotFoundException.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/model/MetadataFilter.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceEntity.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceEvent.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceRepository.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceResponse.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceService.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceController.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/eval/package-info.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/api/DocumentController.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/api/DocumentResponse.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/api/ImportDocumentRequest.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/api/ImportDocumentResponse.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/application/ImportDocumentService.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/domain/DocumentChunk.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/domain/DocumentStatus.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/domain/KnowledgeDocument.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/domain/ParsedMarkdownSection.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/infrastructure/ChunkRepository.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/infrastructure/DocumentRepository.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/infrastructure/MarkdownParser.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/infrastructure/SimpleChunkingService.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/memory/package-info.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/api/KnowledgeQueryController.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/api/KnowledgeQueryRequest.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/api/KnowledgeQueryResponse.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/application/QueryKnowledgeService.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/domain/Citation.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/domain/RetrievedChunk.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/infrastructure/AnswerComposer.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/infrastructure/CitationBuilder.java
knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/infrastructure/KeywordChunkRetriever.java
knowledge-agent-api/src/main/resources/application.yml
knowledge-agent-api/src/test/java/com/huajie/agentknowledge/ingest/infrastructure/MarkdownParserTest.java
knowledge-agent-api/src/test/java/com/huajie/agentknowledge/ingest/infrastructure/SimpleChunkingServiceTest.java
knowledge-agent-api/src/test/java/com/huajie/agentknowledge/ingest/api/ImportDocumentIntegrationTest.java
knowledge-agent-api/src/test/java/com/huajie/agentknowledge/query/application/QueryKnowledgeServiceTest.java
knowledge-agent-api/src/test/java/com/huajie/agentknowledge/query/api/QueryApiIntegrationTest.java
knowledge-agent-api/src/test/java/com/huajie/agentknowledge/common/trace/TraceControllerIntegrationTest.java
```
...
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/AgentKnowledgeApplication.java`
- Create: `knowledge-agent-api/src/main/resources/application.yml`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/memory/package-info.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/eval/package-info.java`
...
```java
package com.huajie.agentknowledge;
 ...
 */
package com.huajie.agentknowledge.memory;
```
 ...
 */
package com.huajie.agentknowledge.eval;
```
...
**Files:**
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/error/ApiErrorResponse.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/error/ErrorCode.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/error/GlobalExceptionHandler.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/error/ResourceNotFoundException.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/model/MetadataFilter.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/domain/DocumentStatus.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/domain/KnowledgeDocument.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/domain/DocumentChunk.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/domain/ParsedMarkdownSection.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/domain/Citation.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/domain/RetrievedChunk.java`
...
```java
package com.huajie.agentknowledge.common.error;
...
```java
package com.huajie.agentknowledge.common.model;
...
```java
package com.huajie.agentknowledge.ingest.domain;
...
```java
package com.huajie.agentknowledge.query.domain;
...
import com.huajie.agentknowledge.ingest.domain.DocumentChunk;
...
```powershell
git add knowledge-agent-api/src/main/java/com/huajie/agentknowledge
...
**Files:**
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/infrastructure/DocumentRepository.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/infrastructure/ChunkRepository.java`
...
```java
package com.huajie.agentknowledge.ingest.infrastructure;

import com.huajie.agentknowledge.ingest.domain.KnowledgeDocument;
...
```powershell
git add knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest
...
**Files:**
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/infrastructure/MarkdownParser.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/infrastructure/SimpleChunkingService.java`
- Create: `knowledge-agent-api/src/test/java/com/huajie/agentknowledge/ingest/infrastructure/MarkdownParserTest.java`
- Create: `knowledge-agent-api/src/test/java/com/huajie/agentknowledge/ingest/infrastructure/SimpleChunkingServiceTest.java`
...
import com.huajie.agentknowledge.ingest.domain.ParsedMarkdownSection;
...
```powershell
git add knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest knowledge-agent-api/src/test/java/com/huajie/agentknowledge/ingest
...
**Files:**
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/api/DocumentController.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/api/DocumentResponse.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/api/ImportDocumentRequest.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/api/ImportDocumentResponse.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/ingest/application/ImportDocumentService.java`
- Create: `knowledge-agent-api/src/test/java/com/huajie/agentknowledge/ingest/api/ImportDocumentIntegrationTest.java`

- [ ] **Step 1: Write failing import integration test**

```java
package com.huajie.agentknowledge.ingest.api;
...
```java
package com.huajie.agentknowledge.ingest.application;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.huajie.agentknowledge.common.error.ErrorCode;
import com.huajie.agentknowledge.common.error.ResourceNotFoundException;
import com.huajie.agentknowledge.ingest.api.DocumentResponse;
import com.huajie.agentknowledge.ingest.api.ImportDocumentRequest;
import com.huajie.agentknowledge.ingest.api.ImportDocumentResponse;
import com.huajie.agentknowledge.ingest.domain.DocumentChunk;
import com.huajie.agentknowledge.ingest.domain.KnowledgeDocument;
import com.huajie.agentknowledge.ingest.domain.ParsedMarkdownSection;
import com.huajie.agentknowledge.ingest.infrastructure.ChunkRepository;
import com.huajie.agentknowledge.ingest.infrastructure.DocumentRepository;
import com.huajie.agentknowledge.ingest.infrastructure.MarkdownParser;
import com.huajie.agentknowledge.ingest.infrastructure.SimpleChunkingService;
...
import com.huajie.agentknowledge.ingest.application.ImportDocumentService;
...
**Files:**
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/api/KnowledgeQueryController.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/api/KnowledgeQueryRequest.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/api/KnowledgeQueryResponse.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/application/QueryKnowledgeService.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/infrastructure/AnswerComposer.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/infrastructure/CitationBuilder.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/infrastructure/KeywordChunkRetriever.java`
- Create: `knowledge-agent-api/src/test/java/com/huajie/agentknowledge/query/application/QueryKnowledgeServiceTest.java`

- [ ] **Step 1: Write failing query service test**

```java
package com.huajie.agentknowledge.query.application;

import com.huajie.agentknowledge.ingest.domain.DocumentChunk;
import com.huajie.agentknowledge.ingest.infrastructure.ChunkRepository;
import com.huajie.agentknowledge.query.api.KnowledgeQueryRequest;
import com.huajie.agentknowledge.query.api.KnowledgeQueryResponse;
import org.junit.jupiter.api.Test;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.test.context.SpringBootTest;
...
```java
package com.huajie.agentknowledge.query.api;
...
import com.huajie.agentknowledge.query.domain.Citation;
...
```java
package com.huajie.agentknowledge.query.infrastructure;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.huajie.agentknowledge.ingest.domain.DocumentChunk;
import com.huajie.agentknowledge.ingest.infrastructure.ChunkRepository;
import com.huajie.agentknowledge.query.domain.RetrievedChunk;
import org.springframework.stereotype.Component;
...
import com.huajie.agentknowledge.query.domain.Citation;
import com.huajie.agentknowledge.query.domain.RetrievedChunk;
import com.huajie.agentknowledge.query.infrastructure.AnswerComposer;
import com.huajie.agentknowledge.query.infrastructure.CitationBuilder;
import com.huajie.agentknowledge.query.infrastructure.KeywordChunkRetriever;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
...
import com.huajie.agentknowledge.query.application.QueryKnowledgeService;
import jakarta.validation.Valid;
import org.springframework.web.bind.annotation.PostMapping;
import org.springframework.web.bind.annotation.RequestBody;
import org.springframework.web.bind.annotation.RequestMapping;
...
```powershell
git add knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query knowledge-agent-api/src/test/java/com/huajie/agentknowledge/query
...
**Files:**
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceEntity.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceEvent.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceRepository.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceResponse.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceService.java`
- Create: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace/TraceController.java`
- Modify: `knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/application/QueryKnowledgeService.java`
- Create: `knowledge-agent-api/src/test/java/com/huajie/agentknowledge/common/trace/TraceControllerIntegrationTest.java`

- [ ] **Step 1: Write failing trace integration test**

```java
package com.huajie.agentknowledge.common.trace;
...
import com.huajie.agentknowledge.common.error.ErrorCode;
import com.huajie.agentknowledge.common.trace.TraceEvent;
import com.huajie.agentknowledge.common.trace.TraceService;
import com.huajie.agentknowledge.query.api.KnowledgeQueryRequest;
import com.huajie.agentknowledge.query.api.KnowledgeQueryResponse;
import com.huajie.agentknowledge.query.domain.Citation;
import com.huajie.agentknowledge.query.domain.RetrievedChunk;
...
```powershell
git add knowledge-agent-api/src/main/java/com/huajie/agentknowledge/common/trace knowledge-agent-api/src/main/java/com/huajie/agentknowledge/query/application/QueryKnowledgeService.java knowledge-agent-api/src/test/java/com/huajie/agentknowledge
...
**Files:**
- Create: `knowledge-agent-api/src/test/java/com/huajie/agentknowledge/query/api/QueryApiIntegrationTest.java`
- Modify: `README.md`
...
```powershell
git add README.md knowledge-agent-api/src/test/java/com/huajie/agentknowledge/query/api/QueryApiIntegrationTest.java
